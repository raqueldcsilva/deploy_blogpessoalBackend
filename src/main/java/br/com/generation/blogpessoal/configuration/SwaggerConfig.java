...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blog Pessoal").description("API do Projeto de Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/raqueldcsilva")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Raquel C Silva", "https://github.com/raqueldcsilva", "raquelshdy@gmail.com");
	}
